...
return [
    ...
    'timestamp' => 1781076918,
    'checksum' => '56b59326a6f462908de44e3ef015ead9',
    'files' => [
        'user/config' => [
            'media' => [
        ...
        'user/themes' => [
            'themes/climateon' => [
                'file' => 'user/themes/climateon/climateon.yaml',
                'modified' => 1781075790
            ]
        ]
    ],
    'data' => [
        'themes' => [
            'climateon' => [
                'name' => 'Climateon',
                'version' => '1.0.0',
                'description' => 'Modern, simple, and powerful green theme for Climateon Magazine',
                'icon' => 'leaf',
                'author' => [
                    'name' => 'Antigravity',
                    'email' => 'support@climateon.id'
                ]
            ]
        ],
        'plugins' => [
